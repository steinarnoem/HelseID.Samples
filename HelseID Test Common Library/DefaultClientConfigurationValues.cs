namespace HelseID.Clients.Common
{
    ...
    {
        public const string DefaultAuthority = "https://localhost:44366/";//"https://helseid-sts.utvikling.nhn.no/";
        public const string DefaultClientId = "wpfdemo"; //"rsaprivatekey.helseid.nhn.no";//"wpfdemo";
